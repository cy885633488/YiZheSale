...
import cn.ucai.yizhesale.adapter.ChatAllHistoryAdapter;
...
public class ChatAllHistoryFragment extends Fragment implements View.OnClickListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		return inflater.inflate(cn.ucai.yizhesale.R.layout.fragment_conversation_history, container, false);
	}
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		errorItem = (RelativeLayout) getView().findViewById(cn.ucai.yizhesale.R.id.rl_error_item);
		...
		final String st2 = getResources().getString(cn.ucai.yizhesale.R.string.Cant_chat_with_yourself);
		...
		String strSearch = getResources().getString(cn.ucai.yizhesale.R.string.search);
	...
	public void onCreateContextMenu(ContextMenu menu, View v, ContextMenuInfo menuInfo) {
		...
		getActivity().getMenuInflater().inflate(cn.ucai.yizhesale.R.menu.delete_message, menu);
		// }
	}
	...
	public boolean onContextItemSelected(MenuItem item) {
		...
		if (item.getItemId() == cn.ucai.yizhesale.R.id.delete_message) {
			deleteMessage = true;
			handled = true;
		} else if (item.getItemId() == cn.ucai.yizhesale.R.id.delete_conversation) {
			deleteMessage = false;
			handled = true;
		}
