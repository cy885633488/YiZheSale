...
import cn.ucai.yizhesale.DemoHXSDKModel;
...
public class SettingsFragment extends Fragment implements OnClickListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		return inflater.inflate(cn.ucai.yizhesale.R.layout.fragment_conversation_settings, container, false);
	}
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		if(savedInstanceState != null && savedInstanceState.getBoolean("isConflict", false))
            return;
		rl_switch_notification = (RelativeLayout) getView().findViewById(cn.ucai.yizhesale.R.id.rl_switch_notification);
		...
		rl_switch_chatroom_leave = (RelativeLayout) getView().findViewById(cn.ucai.yizhesale.R.id.rl_switch_chatroom_owner_leave);

		iv_switch_open_notification = (ImageView) getView().findViewById(cn.ucai.yizhesale.R.id.iv_switch_open_notification);
		iv_switch_close_notification = (ImageView) getView().findViewById(cn.ucai.yizhesale.R.id.iv_switch_close_notification);
		...
		iv_switch_close_vibrate = (ImageView) getView().findViewById(cn.ucai.yizhesale.R.id.iv_switch_close_vibrate);
		iv_switch_open_speaker = (ImageView) getView().findViewById(cn.ucai.yizhesale.R.id.iv_switch_open_speaker);
		iv_switch_close_speaker = (ImageView) getView().findViewById(cn.ucai.yizhesale.R.id.iv_switch_close_speaker);
		
		iv_switch_room_owner_leave_allow = (ImageView) getView().findViewById(cn.ucai.yizhesale.R.id.iv_switch_chatroom_owner_leave_allow);
		iv_switch_room_owner_leave_disallow = (ImageView) getView().findViewById(cn.ucai.yizhesale.R.id.iv_switch_chatroom_owner_leave_not_allow);
		
		
		logoutBtn = (Button) getView().findViewById(cn.ucai.yizhesale.R.id.btn_logout);
		if(!TextUtils.isEmpty(EMChatManager.getInstance().getCurrentUser())){
			logoutBtn.setText(getString(cn.ucai.yizhesale.R.string.button_logout) + "(" + EMChatManager.getInstance().getCurrentUser() + ")");
		}
	...
	public void onClick(View v) {
		switch (v.getId()) {
		case cn.ucai.yizhesale.R.id.rl_switch_notification:
			...
			break;
		case cn.ucai.yizhesale.R.id.rl_switch_sound:
			...
			break;
		case cn.ucai.yizhesale.R.id.rl_switch_vibrate:
			...
			break;
		case cn.ucai.yizhesale.R.id.rl_switch_speaker:
			...
			break;
		case cn.ucai.yizhesale.R.id.rl_switch_chatroom_owner_leave:
		    ...
		    break;
		case cn.ucai.yizhesale.R.id.btn_logout: //退出登陆
			logout();
			break;
		case cn.ucai.yizhesale.R.id.ll_black_list:
			startActivity(new Intent(getActivity(), BlacklistActivity.class));
			break;
		case cn.ucai.yizhesale.R.id.ll_diagnose:
			startActivity(new Intent(getActivity(), DiagnoseActivity.class));
			break;
		case cn.ucai.yizhesale.R.id.ll_set_push_nick:
			startActivity(new Intent(getActivity(), OfflinePushNickActivity.class));
			break;
		case cn.ucai.yizhesale.R.id.ll_user_profile:
