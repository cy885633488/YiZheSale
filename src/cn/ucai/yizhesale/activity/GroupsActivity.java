...
import cn.ucai.yizhesale.adapter.GroupAdapter;
...
public class GroupsActivity extends BaseActivity {
					...
					if (success) {
						...
						if (!GroupsActivity.this.isFinishing()) {
							String s1 = getResources()
									.getString(
											cn.ucai.yizhesale.R.string.Failed_to_get_group_chat_information);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(cn.ucai.yizhesale.R.layout.fragment_groups);

		instance = this;
		inputMethodManager = (InputMethodManager) getSystemService(INPUT_METHOD_SERVICE);
		grouplist = EMGroupManager.getInstance().getAllGroups();
		groupListView = (ListView) findViewById(cn.ucai.yizhesale.R.id.list);
		...
		progressBar = (View)findViewById(cn.ucai.yizhesale.R.id.progress_bar);
