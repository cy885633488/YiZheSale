package cn.ucai.yizhesale.view;
...
import cn.ucai.yizhesale.utils.ImageLoader.OnImageLoadListener;
import cn.ucai.yizhesale.I;
import cn.ucai.yizhesale.R;
import cn.ucai.yizhesale.utils.ImageLoader;
...
public class SlideAutoLoopView extends ViewPager {
    ...
    class SlideAutoLooopAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            String url= imgUrl;
            Bitmap bitmap = imageLoader.displayImage(url, imgName, Utils.px2dp(context, 260),
                    Utils.px2dp(context, 200), new OnImageLoadListener() {
                @Override
