...
//	}
	...
	public String getRequestUrl(String request) throws Exception {
		StringBuilder url = new StringBuilder(YiZheSaleApplication.SERVER_ROOT);
		url.append("?")
				.append(I.KEY_ACT)
				.append("=")
				.append(request)
	...
	public String getRequestUrlPptm(String request) throws Exception {
		StringBuilder url = new StringBuilder(YiZheSaleApplication.PPTM_SERVER_ROOT);
		url.append("?")
				.append(I.KEY_ACT)
				.append("=")
				.append(request)
	...
	public String getRequestUrlSyItem1(String request) throws Exception {
		StringBuilder url = new StringBuilder(YiZheSaleApplication.SY_ITEM1_SERVER_ROOT);
		url.append("?")
				.append(I.Syg.V)
				.append("=")
				.append(request);
    ...
    public String getRequestUrlSyItem2(String request) throws Exception {
        StringBuilder url = new StringBuilder(YiZheSaleApplication.SY_ITEM2_SERVER_ROOT);
		url.append("?")
				.append(I.Syg.V)
				.append("=")
				.append(request);
